@include('admin.hader');
    ...
    @endforeach
      ...
      '                <!--  Amount-->'
                      ...
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="title">Area:</label>
                        <div class="col-lg-10">
                          <input type="text" class="form-control" value="{{$school->area}}" name="area">
                        </div>
                      </div>
                  ...
                  <script type="text/javascript">
                    ...
                    document.forms['edit_form'].elements['s_address'].value='{{$school->s_address}}'
