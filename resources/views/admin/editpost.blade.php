        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>Edit | Remove Post</li>
            </ol>
          </div>
        </div>
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="icon alt"></i>Title </th>
                    <th><i class="icon_alt"></i> Post</th>
                    <th><i class="octicon-file"></i> is_approved</th>
                    <th><i class="icon"></i> status</th>
                    <th><i class="icon_pin_"></i> image</th>


                    <th><i class="icon_cogs"></i> Action</th>
                  </tr>

                  @foreach($editpost as $post_show)
                  <tr>
                    <td>{{$post_show->id}}</td>
                    <td>{{Str::limit($post_show->title,'20')}} </td>
                    <td>{{Str::limit($post_show->body,'20')}}</td>



                    <td>
                       @if($post_show->is_approved==true)
                    ...
                    <td><img src="{{asset($post_show->image)}}" style="height:40px ;width:80px;"></td>
                    <td>
                      <div class="btn-group" style="margin-ri:20px;">
                        <a class="btn btn-primary" href="{{ route('admin.post_edit',$post_show->id) }}">Edit</a>
                        ...
                        <a class="btn btn-danger" data-toggle="modal" href="#myModal2">Delete</a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <a class="btn btn-danger" class="btn btn-danger" type="button" href="{{ route('admin.post_delete',$post_show->id) }}"> Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
