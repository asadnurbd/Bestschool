    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>Remove Comment</li>
            </ol>
          </div>
        </div>
        ...
        <div class="panel-body">
          <header>
            <form class="example" action="{{route('admin.postcomment_search')}}" style="margin:auto;max-width:300px "method="get">
            ...
            <section class="panel">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  ...
                  @foreach($editpostcomment as $postcomment_show)
                  <tr>
                    <td>{{$postcomment_show->id}}</td>
                    <td>{{Str::limit($postcomment_show->comment,'100')}} </td>


                    <td>
                      <div class="btn-group" style="margin-ri:20px;">
                        <a class="btn btn-primary" href="{{ route('admin.postcomment_edit',$postcomment_show->id) }}">Edit</a>
                        ...
                        <a class="btn btn-danger" data-toggle="modal" href="#myModal2">Delete</a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <a class="btn btn-danger" class="btn btn-danger" type="button" href="{{ route('admin.postcomment_delete',$postcomment_show->id) }}"> Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
               ...
               <center>  {{ $editpostcomment->links() }}</center>
