    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-laptop"></i>Edit | Remove School</li>
            </ol>
          </div>
        </div>
        ...
        <div class="panel-body">
          <header>
            <form class="example" action="{{route('admin.school_search')}}" style="margin:auto;max-width:300px "method="get">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th><i class="octicon-file-media"></i> Amount</th>
                  ...
                  @foreach($editschool as $school_show)
                  <tr>
                    <td>{{$school_show->school_name}}</td>
                    <td>{{$school_show->email}} </td>
                    <td>{{$school_show->s_address}}</td>
                    <td>{{$school_show->cost}} </td>
                    <td>{{$school_show->phone}} </td>

                    <td><img src="{{asset($school_show->image)}}" style="height:40px ;width:80px;"></td>
                    <td>
                      <div class="btn-group" style="margin-ri:20px;">
                        <a class="btn btn-primary" href="{{ route('admin.school_edit',$school_show->school_id) }}">Edit</a>
                        ...
                        <a class="btn btn-danger" data-toggle="modal" href="#myModal2">Delete</a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <a class="btn btn-danger" class="btn btn-danger" type="button" href="{{ route('admin.school_delete',$school_show->school_id) }}"> Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
               ...
               <center>  {{ $editschool->links() }}</center>
