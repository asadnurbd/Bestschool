    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-university"></i>User Section</li>
              <li><i class="fa fa-laptop"></i>Edit | Remove User</li>
            </ol>
          </div>
        </div>
        ...
        <div class="panel-body">
          <div class="panel-body">
            <header>
              <form class="example" action="{{route('admin.user_search')}}" style="margin:auto;max-width:300px "method="get">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a class="btn btn-danger"  class="btn btn-danger" type="button"href="{{ route('admin.user_delete',$user->id) }}">Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
