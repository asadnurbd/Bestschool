          ...
          <div class="col-md-6 portlets" style="width: 100%;">
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">Update New Comments</div>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="padd">
            ...
            <div class="form quick-post">
              <!-- Edit profile form (not working)-->
              <form class="form-horizontal" name="edit_form" action="{{route('admin.comment_update',$comment_show->comment_id)}}" method="post" enctype="multipart/form-data">
                 @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <textarea class="form-control" name="comment" id="comment" value="{{$comment_show->comment}}"></textarea>
                  </div>
                </div>
